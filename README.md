This is a small project for fuzzing [Apache Commons Imaging](https://commons.apache.org/proper/commons-imaging/) with the [jazzer](https://github.com/CodeIntelligenceTesting/jazzer) fuzzing tool.
